...
----
  Returns "success" and a count of updated and/or failed parent confidential notes record(s), or a structure of invalid validations messages belonging to parent confidential notes record(s).
...
* **Permission:**
  ...
  Parent Records > Parent Information > Parents > Confidential Notes tab > Add
...
* **Sample GET:** (With URL Encoded `token`)
  ...
  ```HTML
    http://api.tasscloud.com.au/tassweb/api/?method=setParentConfidentialNote&appcode=API04&company=10&v=3&token=l1D8owEn111IHcXLRwXTB0oU2GX6rj%2BISqa9zXA8We3J3mwgjW5pdUvFK3%2FIZ4mJ4bMyfKTmEoup%2B3tTE9GeLQ%3D%3D
  ```
...
* **Sample POST:**
  ...
  ```HTML
    <form id="postForm" name="postForm" method="POST" action="http://api.tasscloud.com.au/tassweb/api/">
       <input type="hidden" name="method" value="setParentConfidentialNote">
