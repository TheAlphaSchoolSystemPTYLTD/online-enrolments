...
* **Error Response:**
    ...
    `e_mail` must be 0.00 or a positive number with 2 decimal points
    ```javascript
    ...
    `par_e_mail` must be 0.00 or a positive number with 2 decimal points
    ```javascript
    ...
    `par_e_mail2` must be 0.00 or a positive number with 2 decimal points
    ```javascript
